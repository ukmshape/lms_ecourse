		...
		echo <<<SCRIPTS
			...
			<style type="text/css">
				table.dBug_array,table.dBug_object,table.dBug_resource,table.dBug_resourceC,table.dBug_xml {
					...
					border-spacing: 2px; border-collapse: separate;border-color: grey;
				}
				...
				/* object */
				table.dBug_object { background-color:#0000CC; border-spacing: 2px; border-collapse: separate;border-color: grey;}
