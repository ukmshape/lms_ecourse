                                      ...
                                      <div class="widget-inner edit-profile">
                                              ...
                                              <?php } ?>
                                                  ...
                                                  <?php if($getForm[0]->installment == 'yes' && $detail_pelajar[0]->ansuran == 'yes') { ?>
                                                    ...
                                                    <div class="form-group col-12">
                                                      ...
                                                      <table id="tbl_list" class="table table-bordered rounded shadow-sm p-3 bg-white rounded">
                                                        ...
                                                        <tbody>
                                                          <tr>
                                                            <td style="font-weight: 500; text-align:center;"><?php if($getForm[0]->deposit <= 0) { echo '-'; } else { ?><input type="date" name="" value="<?=$detail_pelajar[0]->tkh_deposit;?>" <?php if($detail_pelajar[0]->tkh_deposit) { echo "disabled"; } ?> required><?php } ?></td>
                                                            <td style="font-weight: 500; text-align:center;"><?php if($getForm[0]->ins_1 <= 0) { echo '-'; } else { ?><input type="date" name="" value="<?=$detail_pelajar[0]->tkh_payment1;?>" <?php if($detail_pelajar[0]->tkh_payment1) { echo "disabled"; } ?> required><?php } ?></td>
                                                            <td style="font-weight: 500; text-align:center;"><?php if($getForm[0]->ins_2 <= 0) { echo '-'; } else { ?><input type="date" name="" value="<?=$detail_pelajar[0]->tkh_payment2;?>" <?php if($detail_pelajar[0]->tkh_payment2) { echo "disabled"; } ?> required><?php } ?></td>
                                                            <td style="font-weight: 500; text-align:center;"><?php if($getForm[0]->ins_3 <= 0) { echo '-'; } else { ?><input type="date" name="" value="<?=$detail_pelajar[0]->tkh_payment3;?>" <?php if($detail_pelajar[0]->tkh_payment3) { echo "disabled"; } ?> required><?php } ?></td>
                                                          </tr>
                                                          <tr>
                                                            <?php
                                                            $getpayment = 0;
                                                            $i = 0;
                                                              $getpayment = $this->urusetiasp_m->get_paymentloop($detail_pelajar[0]->order_id);
                                                              if($getpayment) {
                                                                foreach($getpayment as $loop) { 
                                                                  $i++;
                                                                ?>
                                                                  <td style="font-weight: 500; text-align:center;">
                                                                  <?php 
                                                                  if(($getForm[0]->total > 0) && $loop->total == $getForm[0]->deposit) { ?>
                                                                    Pay On: <?=$loop->tarikhpayment; ?>
                                                                  <?php } else if($loop->total == $getForm[0]->ins_1) { ?>
                                                                    Pay On: <?=$loop->tarikhpayment; ?>
                                                                  <?php } else if($loop->total == $getForm[0]->ins_2) { ?>
                                                                    Pay On: <?=$loop->tarikhpayment; ?>
                                                                  <?php } else if(($getForm[0]->total > 0) && $loop->total == $getForm[0]->ins_3) { ?>
                                                                    Pay On: <?=$loop->tarikhpayment; ?>
                                                                  <?php } ?>
                                                                  </td>
                                                                <?php }
                                                              }
                                                              while($i <= count($getpayment)) { ?>
                                                ...
                                                <div class="form-group col-12 m-t20">
                                                  <div>
                                                      ...
                                                      <div>
                                                        ...
                                                        $filelink = '';
                                                        $fileName = '';
                                                        $filelink = DOCPATH.$detail_pelajar[0]->user_id.'/'.$detail_pelajar[0]->files;
                                                ...
                                                <div class="col-12 m-t30">
                                                    ...
                                                    <?php if($detail_pelajar[0]->status_urus == 5) { ?>
