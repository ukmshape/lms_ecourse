...
<style>
    ...
    .enableborder {
        box-shadow: 1; /* You may want to include this as bootstrap applies these styles too */
    }
</style>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="col-3 m-b5" style="padding-left: 0px;">
                                        ...
                                        <div>
                                            <input class="form-control shadow-sm p-3 bg-white rounded" type="text" value="<?php echo ($detail_pelajarspff001[0]->create_dated); ?>" disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group col-6">
                                    ...
                                    <div>
                                        <input class="form-control shadow-sm p-3 bg-white rounded" type="text" value="<?php echo ($detail_pelajarspff001[0]->nama); ?>" disabled>
                                    </div>
                                </div>
                                <div class="form-group col-6">
                                    <label class="col-form-label">IC Number</label>
                                    <div>
                                        <input class="form-control shadow-sm p-3 bg-white rounded" type="text" value="<?php echo ($detail_pelajarspff001[0]->nokp); ?>" disabled>
                                    </div>
                                </div>
                                <div class="form-group col-6">
                                    <label class="col-form-label">Email</label>
                                    <div>
                                        <input class="form-control shadow-sm p-3 bg-white rounded" type="text" value="<?php echo ($detail_pelajarspff001[0]->emel); ?>" disabled>
                                    </div>
                                </div>
                                <div class="form-group col-6">
                                    <label class="col-form-label">Phone Number</label>
                                    <div>
                                        <input class="form-control shadow-sm p-3 bg-white rounded" type="text" value="<?php echo ($detail_pelajarspff001[0]->notel); ?>" disabled>
                                    </div>
                                </div>
                                <div class="form-group col-12">
                                    <label class="col-form-label">Address</label>
                                    <div>
                                        <input class="form-control shadow-sm p-3 bg-white rounded" type="text" value="<?php echo ($detail_pelajarspff001[0]->alamat1); ?>" disabled>
                                    </div><br>
                                    <div>
                                        <input class="form-control shadow-sm p-3 bg-white rounded" type="text" value="<?php echo ($detail_pelajarspff001[0]->alamat2); ?>" disabled>
                                    </div><br>
                                    <div>
                                        <input class="form-control shadow-sm p-3 bg-white rounded" type="text" value="<?php echo ($detail_pelajarspff001[0]->alamat3); ?>" disabled>
                                    </div>
                                </div>
                                <div class="form-group col-6">
                                    <label class="col-form-label">City</label>
                                    <div>
                                        <input class="form-control shadow-sm p-3 bg-white rounded" type="text" value="<?php echo ($detail_pelajarspff001[0]->bandar); ?>" disabled>
                                    </div>
                                </div>
                                <div class="form-group col-6">
                                    <label class="col-form-label">State</label>
                                    <div>
                                        <input class="form-control shadow-sm p-3 bg-white rounded" type="text" value="<?php echo ($detail_pelajarspff001[0]->negeri); ?>" disabled>
                                    </div>
                                </div>
                                <div class="form-group col-6">
                                    <label class="col-form-label">Postcode</label>
                                    <div>
                                        <input class="form-control shadow-sm p-3 bg-white rounded" type="text" value="<?php echo ($detail_pelajarspff001[0]->poskod); ?>" disabled>
                                    </div>
                                </div>
                                <div class="form-group col-6">
                                    <label class="col-form-label">Country</label>
                                    <div>
                                        <input class="form-control shadow-sm p-3 bg-white rounded" type="text" value="<?php echo ($detail_pelajarspff001[0]->negara); ?>" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-6 m-t20">
                                    ...
                                    <div>
                                        <input class="form-control shadow-sm p-3 bg-white rounded" type="text" id="txt_higheredu" name="txt_higheredu" value="<?php echo ($detail_pelajarspff001[0]->akadtertinggi); ?>" disabled>
                                    </div>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <div>
                                        <input class="form-control shadow-sm p-3 bg-white rounded" type="text" id="txt_companyname" name="txt_companyname" value="<?php if(!empty($detail_pelajarspff001)) { echo ($detail_pelajarspff001[0]->nmsyrkt); } else { } ?>" disabled>
                                    </div>
                                </div>
                                <div class="col-12 m-t40">
                                    <div class="ml-auto m-b5">
                                ...
                                <div class="col-12">
                                    <div class="col-3 m-b5" style="padding-left: 0px;">
                                        ...
                                        <div>
                                            <input class="form-control shadow-sm p-3 bg-white rounded" type="text" id="txt_paymentdate" name="txt_paymentdate" value="<?php echo ($detail_pelajarspff001[0]->create_dated); ?>" disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="col-6 m-b7" style="padding-left: 0px;">
                                        <label class="col-form-label">Courses Taken</label>
                                        <div>
                                            <input class="form-control shadow-sm p-3 bg-white rounded" type="text" id="txt_kursustaken" name="txt_kursustaken" value="<?php echo ($detail_pelajarspff001[0]->namakursus); ?>" disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group col-6">
                                    ...
                                    <div>
                                        <input class="form-control shadow-sm p-3 bg-white rounded" type="text" id="txt_sponsor" name="txt_sponsor" value="<?php if(!empty($detail_pelajarspff001)) { echo ($detail_pelajarspff001[0]->nmsyrkt); } else { } ?>" disabled>
                                    </div>
                                </div>
                                <div class="form-group col-6">
                                    <label class="col-form-label">Sponsorship Phone Number</label>
                                        <div>
                                            <input class="form-control shadow-sm p-3 bg-white rounded" type="text" id="txt_sponsortelno" name="txt_sponsortelno" value="<?php echo ($detail_pelajarspff001[0]->notelsyrkt); ?>" disabled>
                                        </div>
                                </div>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <div>
                                        <input class="form-control shadow-sm p-3 bg-white rounded" type="text" id="txt_sponsoremail" name="txt_sponsoremail" value="<?php echo ($detail_pelajarspff001[0]->emelsyrkt); ?>" disabled>
                                    </div>
                                </div><br><br><br><br>
                                ...
                                <div class="form-group col-12">
                                  <table id="tbl_list" class="table table-bordered rounded shadow-sm p-3 bg-white rounded">
                                    ...
                                    <tbody>
                                      <tr>
                                        <td style="font-weight: 500; text-align:center;"><input class="form-control no-border" type="text" id="txt_firstpay" name="txt_firstpay" style="font-weight: 500; text-align:center;" value="<?php if($detail_pelajarspff001[0]->status_payment1 == "3") {  echo "Unpaid"; } elseif ($detail_pelajarspff001[0]->status_payment1 == "4"){ echo "Paid";} ?>" disabled></td>
                                        <td style="font-weight: 500; text-align:center;"><input class="form-control no-border" type="text" id="txt_secondpay" name="txt_secondpay" style="font-weight: 500; text-align:center;" value="<?php if($detail_pelajarspff001[0]->status_payment2 == "3") {  echo "Unpaid"; } elseif ($detail_pelajarspff001[0]->status_payment2 == "4"){ echo "Paid";} ?>" disabled></td>
                                        <td style="font-weight: 500; text-align:center;"><input class="form-control no-border" type="text" id="txt_thirdpay" name="txt_thirdpay" style="font-weight: 500; text-align:center;" value="<?php if($detail_pelajarspff001[0]->status_payment3 == "3") {  echo "Unpaid"; } elseif ($detail_pelajarspff001[0]->status_payment3 == "4"){ echo "Paid";} ?>" disabled></td>
                                      </tr>
                                      <tr>
                                        <td colspan="2" style="font-weight: 500; text-align:right; vertical-align:middle;">TOTAL PROGRAM PAYMENT</td>
                                        <td style="text-align:center;"><input class="form-control no-border" type="text" id="txt_totalProgram" name="txt_totalProgram" style="font-weight: 500; text-align:center;" value="<?php echo "RM ".($detail_pelajarspff001[0]->totalprice); ?>" readonly></td>
                                      </tr>
                                      <!-- <tr>
