...
<main class="ttr-wrapper">
    <div class="container-fluid">
        ...
        <?php if (!empty($list_infopelajarsp)) : ?>
            <div class="row">
                ...
                <div class="col-lg-12 m-b30">
                    <div class="widget-box">
                        <table id="example" class="table table-bordered table-striped">
                            ...
                            <tbody>
                            <?php $num = 0; ?>
                            <?php foreach ($list_infopelajarsp as $row) {
                                ++$num; ?>
                                    <tr>
                                        ...
                                        <td style="text-align:left; vertical-align:middle;">
                                          <?php
                                            ...
                                            } else if($liststatus[0]->status_id == '15') {
                                              echo "<span class='text-red font-weight-bold'>".$liststatus[0]->status."</span>";
                                            } else if($liststatus[0]->status_id == '14') {
                                              echo "<span class='text-red font-weight-bold'>".$liststatus[0]->status."</span>";
                                            } else if($liststatus[0]->status_id == '23') {
