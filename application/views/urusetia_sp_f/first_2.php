                                ...
                                <div class="widget-inner edit-profile">
                                          ...
                                          <div class="form-group col-3">
                                              <div>
                                                <label class="col-form-label">&nbsp;</label>
                                                  <div>
                                                      <a href="<?=base_url('/urusetia_sp/cpayment/').$parameter;?>" target="_blank" class="btn red" style="color:#fff;">Invoice</a>
                                                  </div>
                                              </div>
                                          </div>
                                          <div class="seperator"></div>
                                                  ...
                                                  <tbody>
                                                      <tr>
                                                          ...
                                                          <td style="vertical-align:middle;">
                                                            <input type="hidden" name="txt_orderspid[]" value="<?php echo $row->id; ?>">
                                                            <input type="hidden" name="txt_ordersp_id[]" value="<?php echo $row->order_id; ?>">
                                        ...
                                        -->
                                          ...
                                          <div class="col-12 m-t30">
                                              <a href="<?=base_url('/urusetia_sp/detail_pemohon/').$parameter;?>" class="btn-secondry" style="color:#fff;">Back</a>
