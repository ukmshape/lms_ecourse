...
<main class="ttr-wrapper">
    <div class="container-fluid">
        <div class="db-breadcrumb">
            <h4 class="breadcrumb-title">Custom Field</h4>
                ...
                <div class="col-lg-12 m-b30">
                    <div class="widget-box">
                      <div class="col-lg-12 m-b30 p-t30">
                        <a name="detail_pemohon" href="<?=base_url('/custom/add_custom_field');?>" class="btn red" title="Action">Add More Field</a>
                      </div>
                        <table id="example" class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align:center; vertical-align:middle;">Shortname</th>
                                    <th style="text-align:center; vertical-align:middle;">Value</th>
                                    <th style="text-align:center; vertical-align:middle;">Required</th>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($list_course as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center; vertical-align:middle;"><?php echo $row->shortname; ?></td>
                                                <td style="vertical-align:middle;"><?php echo $row->value; ?></td>
                                                <td style="text-align:center; vertical-align:middle;">
                                                  <?php
                                                  if($row->required == 'yes') {
                                                    echo '<span style="color:#34bfa3;"><i class="fa fa-check-square"></i></span>';
                                                  } else {
                                                    echo '<span style="color:#f0526d;"><i class="fa fa-minus-square"></i></span>';
                                                  }
                                                   ?>
                                                </td>
                                                <td style="text-align:center; vertical-align:middle;">
                                                  <?php
                                                  if($row->show_field == 'yes') {
                                                    echo '<span style="color:#34bfa3;"><i class="fa fa-check-square"></i></span>';
                                                  } else {
                                                    echo '<span style="color:#f0526d;"><i class="fa fa-minus-square"></i></span>';
                                                  }
                                                ...
                                                <td align="center">
                                                    <?php $parameter = $row->custom_id; ?>
                                                        <a name="detail_pemohon" href="<?php echo base_url('/custom/edit_custom_field/'.$this->encryption->encrypt($parameter)); ?>" class="btn button-sm blue" title="Action"><i class="fa fa-edit"></i></a>
                                                        <a name="detail_pemohon" href="<?php echo base_url('/custom/delete/'.$this->encryption->encrypt($parameter)); ?>" class="btn button-sm red" title="Action"><i class="fa fa-trash"></i></a>
