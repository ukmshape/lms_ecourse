                            ...
                            <tbody>
                                ...
                                <?php foreach ($list_course as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <?php $parameter = $row->course_id; ?>
                                                        <a name="detail_pemohon" href="<?php echo base_url('/custom/detail_custom/'.$this->encryption->encrypt($parameter)); ?>" class="btn bg-gradient-success" title="Action">Add Custom Form</a>
