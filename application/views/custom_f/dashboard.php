                    ...
                    <div class="widget-inner">
                        ...
                        <div class="row text-center">
                          <div class="col-lg-6 col-md-6 mt-3">
                            <a href="<?= base_url('custom/custom_field') ?>">
                                <div class="card shadow" style="border-radius: 10px;">
                                    <div class="card-body"><i class="fas fa-desktop fa-2xl fa-icolor fa-scolor"></i><br><br>Custom Field</div>
                                </div>
                            </a>
                          </div>
                          <div class="col-lg-6 col-md-6 mt-3">
                            <a href="<?= base_url('custom/custom_list') ?>">
                                <div class="card shadow" style="border-radius: 10px; pointer-events: none;">
                                    <div class="card-body"><i class="fas fa-certificate fa-2xl fa-icolor fa-scolor"></i><br><br>Course Form</div>
                                </div>
                            </a>
                          </div>
                        </div>
