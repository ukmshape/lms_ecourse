                ...
                <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            ...
                            <img src="<?= base_url() ?>/assets/img/banner.png" alt="..." style="width: 100%; height: 250px !important; border-radius: 10px;">
                            <div class="carousel-caption ">
                                <h3 style="text-align: left; margin-bottom: 85px; text-shadow: 2px 2px 5px #ED1C24;">Welcome Back, <br><?= $nama; ?></h3>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="widget-box shadow">
                    ...
                    <div class="widget-inner">
                        <table border="0">
                            <tr align="center">
                                <td>
                                    <a href="<?= base_url('fakulti/semak_SPNF001') ?>">
                                        <div class="card shadow" style="border-radius: 10px;">
                                            <div class="card-body"><i class="fas fa-desktop fa-2xl fa-icolor fa-scolor"></i><br><br>Professional Certificate Halal Pharmapreneur<br>Application Review</div>
                                        </div>
                                    </a>
                                </td>
                                <td>
                                    <a href="<?= base_url('fakulti/semak_SPFF001') ?>">
                                        <div class="card shadow" style="border-radius: 10px; pointer-events: none;">
                                            <div class="card-body"><i class="fas fa-certificate fa-2xl fa-icolor fa-scolor"></i><br><br>Professional Certificate Ultrasound Obstetrik & Ginekologi<br>Application Review</div>
                                        </div>
                                    </a>
                                </td>
                            </tr>
                            <!-- <tr align="center">
                                <td>
                                    <a href="<-?= base_url('urusetia_sc/dash_admin') ?>" style="pointer-events: none">
                                    <a href="#">
                                        <div class="card shadow" style="border-radius: 10px; ">
                                            <div class="card-body"><i class="fas fa-book-open fa-2xl fa-icolor fa-scolor"></i><br><br>Short Courses <br>Application Review</div>
                                        </div>
                                    </a>
                                </td>

                                <td>
                                    <a href="<-?= base_url('kewangan/dash_kew') ?>">
                                        <div class="card shadow" style="border-radius: 10px;">
                                            <div class="card-body"><i class="fas fa-money fa-2xl fa-icolor fa-scolor"></i><br><br>Finance <br>Department</div>
                                        </div>
                                    </a>
                                </td>
