                    ...
                    <div class="widget-inner">
                        <div class="row text-center">
                            <div class="col-lg-6 col-md-6 mt-3">
                                <a href="<?= base_url('urusetia_mc/dash_admin') ?>">
                                    <div class="card shadow" style="border-radius: 10px;">
                                        <div class="card-body"><i class="fas fa-desktop fa-2xl fa-icolor fa-scolor"></i><br><br>Micro-credential Application Review</div>
                                    </div>
                                </a>
                            </div>
                            <div class="col-lg-6 col-md-6 mt-3">
                                <a href="<?= base_url('urusetia_sp/dash_adminsp') ?>">
                                    <div class="card shadow" style="border-radius: 10px;">
                                        <div class="card-body"><i class="fas fa-certificate fa-2xl fa-icolor fa-scolor"></i><br><br>Professional Certificate Application Review</div>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="row text-center mt-3">
                            <div class="col-lg-6 col-md-6 mt-3">
                                 ...
                                 <a href="#">
                                    <div class="card shadow" style="border-radius: 10px; ">
                                        <div class="card-body"><i class="fas fa-book-open fa-2xl fa-icolor fa-scolor"></i><br><br>Short Courses Application Review</div>
                                    </div>
                                </a>
                            </div>
                            <div class="col-lg-6 col-md-6 mt-3">
                                <a href="<?= base_url('custom/dashboard') ?>">
                                    <div class="card shadow" style="border-radius: 10px;">
                                        <div class="card-body"><i class="fas fa-cogs fa-2xl fa-icolor fa-scolor"></i><br><br>Custom Form Application</div>
                                    </div>
                                </a>
                            </div>
                        </div>
