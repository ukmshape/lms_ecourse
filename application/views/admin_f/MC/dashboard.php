    ...
    <div class="container-fluid">
        <div class="db-breadcrumb">
            ...
            <ul class="db-breadcrumb-list">
                ...
                <li>Dashboard Micro-credential</li>
            </ul>
        </div>
        <!-- Your Profile Views Chart -->
        <!-- <div class="row">
            <div class="col-lg-12 m-b30">
                <div class="widget-box shadow" style="height:200px; background-image:url(<-?= base_url() ?>/assets/img/1.png); background-size:stretch; ">
                    <div class=" widget-inner">
                        <h3 style="text-shadow: 2px 2px 5px #ED1C24">MICRO-CREDENTIAL</h3>
                    </div>
                </div>
            </div>
        </div> -->
                ...
                <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="<?= base_url() ?>/assets/img/mc.png" alt="..." style="width: 100%; height: 250px !important; border-radius: 10px;">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3 col-xl-3 col-sm-6 col-12">
                <div class="widget-card widget-bg1 shadow">
                    <div class="wc-item">
                        ...
                        <span class="wc-stats">
                            <span class="number"><?php echo ($countTotal); ?></span>
                        </span>
                        <span class="wc-des">
                            &nbsp;
                        </span>
            ...
            <div class="col-md-6 col-lg-3 col-xl-3 col-sm-6 col-12">
                <div class="widget-card shadow" style="background: linear-gradient(90deg, rgba(92,217,60,1) 32%,  rgba(5,179,33,1) 93%);">
                    <div class="wc-item">
                        ...
                        <span class="wc-stats">
                            <span class="number"><?php echo ($countCompleted); ?></span>
                        </span>
                        <span class="wc-des">
                            &nbsp;
                        </span>
            ...
            <div class="col-md-6 col-lg-3 col-xl-3 col-sm-6 col-12">
                <div class="widget-card widget-bg3 shadow">
                    <div class="wc-item">
                        ...
                        <span class="wc-stats">
                            <span class="number"><?php echo ($countInompleted); ?></span>
                        </span>
                        <span class="wc-des">
                            &nbsp;
                        </span>
            ...
            <div class="col-md-6 col-lg-3 col-xl-3 col-sm-6 col-12">
                <div class="widget-card widget-bg4 shadow">
                    <div class="wc-item">
                        ...
                        <span class="wc-stats">
                            <span class="number"><?php echo ($countTotalcourse); ?></span>
                        </span>
                        <span class="wc-des">
                            &nbsp;
                        </span>
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-inner">
                        <table border="0">
                            <tr align="center">
                                <td>
                                    <a href="<?= base_url('urusetia_mc/semak_mc') ?>">
                                        <div class="card shadow" style="border-radius: 10px;">
                                            <div class="card-body"><i class="fas fa-list-alt fa-2xl fa-icolor fa-scolor"></i><br><br>Application Review</div>
                                        </div>
                                    </a>
                                </td>
                                <!-- <td>
                                    <a href="<?= base_url('urusetia_mc/daftarpensyarah') ?>">
                                        <div class="card shadow" style="border-radius: 10px;">
                                            <div class="card-body"><i class="fas fa-chalkboard-teacher fa-2xl fa-icolor fa-scolor"></i><br><br>Lecturer Registration</div>
                                        </div>
                                    </a>
                                </td> -->
                                <td>
                            ...
                            <!-- <tr align="center">
                                <td>
                                    <a href="<?= base_url('urusetia_mc/reg_kursus_induk') ?>">
                                        <div class="card shadow" style="border-radius: 10px;">
                                            <div class="card-body"><i class="fas fa-certificate fa-2xl fa-icolor fa-scolor"></i><br><br>Courses Registration</div>
                                        </div>
                                    </a>
                                </td>
                                <td>
                                    <a href="<?= base_url('urusetia_mc/reg_kursus_unit') ?>">
                                        <div class="card shadow" style="border-radius: 10px;">
                                            <div class="card-body"><i class="fas fa-stamp fa-2xl fa-icolor fa-scolor"></i><br><br>Courses Registration by Unit</div>
                                        </div>
                                    </a>
                                </td>

                                <td>
                                    <a href="<?= base_url('urusetia_mc/param_kursus') ?>">
                                        <div class="card shadow" style="border-radius: 10px;">
                                            <div class="card-body"><i class="fas fa-cog fa-2xl fa-icolor fa-scolor"></i><br><br>Courses Parameter</div>
                                        </div>
                                    </a>
                                </td>
