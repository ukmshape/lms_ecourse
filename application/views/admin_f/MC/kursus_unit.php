    ...
    <div class="container-fluid">
        <div class="db-breadcrumb">
            ...
            <ul class="db-breadcrumb-list">
                ...
                <li>Course Registration By Unit</li>
            </ul>
        </div>
        <!-- Your Profile Views Chart -->
        <div class="row">
            <div class="col-lg-12 m-b30">
                <h4><b>Course Registration By Unit</b></h4>
            </div>
        </div>
        <!-- Card -->
        <div class="row">
            <div class="col-md-12">
                <div class="widget-card widget-bg1">
                   ...
                   <div class="m-4">
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label col-form-label">Unit No.</label>
                            <div class="col-sm-5">
                                <input type="email" class="form-control form-control" placeholder="Unit No.">
                            </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label">Main Course</label>
                            <div class="col-sm-5">
                                <input type="email" class="form-control"placeholder="Main Course ">
                            </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label">Credit</label>
                            <div class="col-sm-5">
                                <input type="email" class="form-control"placeholder="Credit">
                            </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label">Course Level</label>
                            <div class="col-sm-5">
                                <input type="email" class="form-control"placeholder="Course Level">
                            </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label">Synopsis</label>
                            <div class="col-sm-5">
                                <input type="email" class="form-control"placeholder="Synopsis">
                            </div>
                    </div>
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label">Synopsis BI</label>
                            <div class="col-sm-5">
                                <input type="email" class="form-control"placeholder="Synopsis BI">
                            </div>
                    </div> 
                        <!-- wina -->                  
