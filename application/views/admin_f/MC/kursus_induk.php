...
<main class="ttr-wrapper">
    <div class="container-fluid">
        <div class="db-breadcrumb">
            <h4 class="breadcrumb-title">Urusetia MC</h4>
            <ul class="db-breadcrumb-list">
                <li><a href="#"><i class="fa fa-home"></i>Urusetia</a></li>
                <li>Daftar Kursus Induk</li>
            </ul>
        </div>
        <!-- Your Profile Views Chart -->
        <div class="row">
            <div class="col-lg-12 m-b30">
                <h4><b>Skrin Kursus Induk</b></h4>
            </div>
        </div>
        <!-- Hasanah-->
        <div class="row">
            <div class="col-sm-9">
                <div class="widget-card widget-bg1">
                    ...
                    <div class="row">
                        <div class="col-sm-9">
                          Kod Kursus: <input type="text" class="form-control" placeholder="" name="kodkursusinduk">
                        </div>
                         <div class="col-sm-9">
                        <br>
                          Nama Kursus: <input type="text" class="form-control" placeholder="" name="nmkursus">
                        </div>
                         <div class="col-sm-9">
                         <br>
                          Nama Kursus BI: <input type="text" class="form-control" placeholder="" name="nmkursusbi">
                        </div>
                        <div class="col-sm-9">
                        <br>
                          Unit Penuh: <input type="text" class="form-control" placeholder="" name="unitpenuh">
                        </div>
                        </div>
                       <br>
                      <div class="dropdown">
                        <label for="exampleDataList" class="form-label">Kod Fakulti</label>
                        <input class="form-control" list="datalistOptions" id="exampleDataList" placeholder="Carian...">
