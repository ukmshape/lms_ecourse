                ...
                <div class="col-lg-12 m-b30">
                    <div class="widget-box">
                      <div class="col-lg-12 m-b30 p-t30">
                        <a name="detail_pemohon" href="<?=base_url('/user/add_user');?>" class="btn red" title="Action">Add User</a>
                      </div>
                        <table id="example" class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align:center; vertical-align:middle;">Faculty</th>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($list_user as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align:middle;"><?php echo $row->faculty; ?></td>
                                                <td style="text-align:center; vertical-align:middle;"><?php echo $row->active; ?></td>

                                                <td align="center">
                                                    <?php $parameter = $row->id; ?>
                                                        <a name="detail_pemohon" href="<?php echo base_url('/user/password_user/'.$this->encryption->encrypt($parameter)); ?>" class="btn button-sm yellow" title="Action"><i class="fa fa-lock"></i></a>
