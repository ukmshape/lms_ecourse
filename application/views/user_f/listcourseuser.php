                            ...
                            <tbody>
                                ...
                                <?php foreach ($list_course as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align:middle;"><?php echo $row->idnumber; ?></td>
                                                <td style="vertical-align:middle;"><?php echo $row->fullname; ?></td>
                                                <td style="text-align:center; vertical-align:middle;"><?php echo $row->nmcategory; ?></td>
                                                <td style="text-align:center; vertical-align:middle;">
                                                  <?php
                                                  $totalenrol = $this->user_m->get_totalenrolment($row->id);

                                                  if($totalenrol) {
                                                    echo count($totalenrol);
                                                  } else {
                                                    echo 0;
                                                  }
                                                  ?>
                                                ...
                                                <td align="center">
                                                    <?php $parameter = $row->id; ?>
                                                        <a name="detail_pemohon" href="<?php echo base_url('/user/user_roles/'.$this->encryption->encrypt($parameter)); ?>" class="btn bg-gradient-success" title="Action">User Roles</a>
