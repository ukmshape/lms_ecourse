                              ...
                              <form id="form_addfield" class="edit-profile m-b30" action="" method="post">
                                  ...
                                  <div class="col-12">
                                            ...
                                            <div class="col-md-2">
                															...
                															<div>
                																<input class="form-control" type="password" id="txt_password" name="txt_password" minlength="8" pattern="^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[#?!@$%^&*-/(/)]).{8,}$" value="<?=$password;?>" placeholder="Password" <?php if($password == ''){ echo "required"; } ?>>
                															</div>
                														</div>
                														<div class="col-md-2">
