  ...
  <div class="section-area section-sp2">
      ...
      <div class="row">
        <div class="col-md-12 heading-bx text-center">
          <h2 class="title-head text-uppercase m-b0">Thank you for your application</h2>
          <p style="font-size: 15pt;"><b>We will notify you once the payment has been receive.</b></p>
        </div>
      </div>
